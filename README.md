...
- Make sure you can log into [codesandbox.io](https://codesandbox.io/) using your GitHub account
- Take a screenshot of two projects (one screenshot each) and name them something meaningful like "penguin_scratch_game.png"
...
6. **GIT:** If you are going to be doing more programming I highly recommend doing a <a href="https://github.com/skills/introduction-to-github?tab=readme-ov-file">quick tutorial on git</a>. Save your program as you go with git and easily roll back to previous saves if something goes horribly wrong. Which it will.
